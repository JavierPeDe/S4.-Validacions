...
function validacion() {
    ...
    if (inputEmail1.value == "") {
        ...
        inputEmail1.classList.add("is-invalid");
        document.getElementById("eEmail1").textContent = "Este email no es válido.";
        error++;
    }
    ...
    if (inputEmail2.value == "") {
        ...
        inputEmail2.classList.add("is-invalid");
        document.getElementById("eEmail2").textContent = "El email no coincide, vuelve a comprobarlo.";
        error++;
    }
    ...
    if (!gridCheck.checked) {
        ...
        document.getElementById("eCheck").textContent = "Es obligatorio aceptar las condiciones legales.";
        error++;
    }
...
// Mínim un número
// Mínim 8 caràcters
//Acepta caracteres especiales. Pero no que empiece por ellos. 
